...
public class Artikel {
    ...
    public Artikel(String title, String summary, String content, Integer size) {
        this.title = title;
    ...
    public Artikel(String title, String summary, String content, Integer id, Date createdAt, Boolean deleted) {
        this.title = title;
        this.summary = summary;
        this.content = content;
